...
#define ATTR_KERNOTIME	0x0100	/* [kernel] don't update inode timestamps */
#define ATTR_KERNOVAL	0x0200	/* [kernel] get attr size only, not value */
#define ATTR_KERNAMELS	0x0400	/* [kernel] list attr names (simple list) */
#define ATTR_KERNFULLS	0x0800	/* [kernel] full attr list, ie. root+user */
