...
vnodeops_t xfs_vnodeops = {
	...
	vop_read:		xfs_read,
	vop_write:		xfs_write,
	vop_release_page:	xfs_release_page,
	vop_read_full_page:	xfs_read_full_page,
	vop_write_full_page:	xfs_write_full_page,
	vop_prepare_write:	xfs_prepare_write,
	vop_commit_write:	xfs_commit_write,
	vop_ioctl:		xfs_ioctl,
